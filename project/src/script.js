...
const vnTranslateButton = document.querySelector(`.flag-vn`)
...
const fbLinkButton = document.querySelector(`.facebook`)
...
enTranslateButton.addEventListener(`click`, ()=>
{
    ...
    Hi, I'm Duong, the developer behind this web application welcoming you. 
...
vnTranslateButton.addEventListener(`click`, ()=>
{
    document.querySelector(`.about-title`).textContent = `Giới thiệu`
    aboutText.textContent = `
    Xin chào, tôi tên là Dương, chào mừng bạn ghé thăm đến trang web của tui. 
    Lý do tôi tạo ra trang web này? Tôi nảy ra ý tưởng này khi tôi nhớ lại về kỉ niệm của mình
    với khu vui chơi gần nhà. Sau đó tôi nảy ra ý tưởng rằng sao mình không tạo ra một khu vui chơi ảo
    dể khiến bản thân và mọi người ghé thăm có thể khiến ai cũng cảm thấy yên bình và nhớ lại những ký ức đẹp
    do đó tôi đã tạo ra trang web này.
    `
...
{
    window.open(`https://github.com/duongve13112002`, `_blank`).focus()
})

fbLinkButton.addEventListener(`click`, ()=>
{
    window.open(`https://www.facebook.com/duong.nguyenvu.1311`, `_blank`).focus()
})

twitterLinkButton.addEventListener(`click`, ()=>
{
    window.open(`https://twitter.com/duongve56`, `_blank`).focus()
})
